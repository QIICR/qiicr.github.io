...
comments: true
header:
  image_fullwidth: chicago-atrium.jpg
categories:
  - outreach
---
...
## dcmqi (DICOM for Quantitative Imaging) library
...
of 3D Slicer. The updated extension now allows you to segment DICOM data, compute segmentation-based
